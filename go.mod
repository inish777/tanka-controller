module github.com/inish777/dev/tanka-controller
...
replace github.com/opencontainers/go-digest => github.com/opencontainers/go-digest v1.0.1-0.20230529151907-63939eb433f7
